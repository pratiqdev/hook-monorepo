    ...
    return(
        <Layout {...data}>
            ...
            <div style={{paddingBottom: '0rem'}}>
                ...
                <div style={{display: 'flex', marginBottom:'0rem', padding: '.25rem', paddingBottom:0, paddingTop:'.5rem', background: '#000', width: '24rem', justifyContent:'center', borderTopLeftRadius: '.5rem', borderTopRightRadius: '.5rem', cursor: 'not-allowed'}}>
                    {keys1.map(x =>
                    <p style={{
                        width: '2rem', 
                        height: '2rem', 
                ...
                <div style={{display: 'flex', marginBottom:'0rem', padding: '.25rem', paddingBottom:0, background: '#000', width: '24rem', justifyContent:'center', cursor: 'not-allowed'}}>
                    {keys2.map(x =>
                    <p style={{
                        width: '2rem', 
                        height: '2rem', 
                ...
                <div style={{display: 'flex', marginBottom:'1rem', padding: '.25rem', background: '#000', width: '24rem', justifyContent:'center', paddingBottom: '.5rem', borderBottomLeftRadius: '.5rem', borderBottomRightRadius:'.5rem', cursor: 'not-allowed'}}>
                    {keys3.map(x =>
                    <p style={{
                        width: '2rem', 
                        height: '2rem', 
