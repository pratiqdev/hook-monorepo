// import { useState, useContext, createContext, useEffect, useRef, useMemo } from "react";
...
// const W3MCTX = createContext<any>({});
...
// 	const [state, setState] = useState<any>(config.initialState || null);
