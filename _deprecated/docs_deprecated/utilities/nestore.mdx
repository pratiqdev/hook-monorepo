---
title: nestore
description: Easy to use key:value store with an advanced state-management api and built-in / custom adapters
---
...
![logo-banner](/img/nestore.png)

<p align='center'>
<img src='https://img.shields.io/badge/license_MIT-darkblue' className='mr-2' />
<img src='https://img.shields.io/badge/npm_1.4.X-darkblue' className='mr-2'/>
...
:::note
Adapters should sync after save by requesting data from storage and loaded what was 
returned from storage after the update (most db operations return the updated db 
entry after mutations)

**Prevent excessive DB operations**  
This example does not include a method of throttling or checking for successful writes to the database.
